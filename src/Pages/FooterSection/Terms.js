  ...
  return (
    <Container>
      ...
      <p className="pb-2 text-justify">
        ...
        USING THIS WEBSITE. All users of this site agree that access to and use
        of this site are subject to the following terms and conditions and other
      ...
      <p className="pb-5 text-justify">
        ...
        electronically copy and print hard copy portions of this site for the
        sole purpose of placing an order or purchasing our products. You may
        ...
        non-commercial use, or to place an order with us or to purchase our
        ...
        strictly prohibited, unless authorized. You further agree not to change
