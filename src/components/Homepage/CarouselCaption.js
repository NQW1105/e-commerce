...
const CarouselCaption = () => {
  return (
    // <Container className="">
    <Row className="mx-0 py-3 shadow bg-alt-primary">
      {/* sm={12} lg={4} */}
      <Col xs={4} className="text-white">
        <div className="d-flex flex-column flex-md-row justify-content-center align-items-center gap-2 ">
          ...
          <p className="m-0 fw-semibold text-center">Free Shipping</p>
        </div>
      </Col>
      <Col xs={4} className="text-white">
        <div className="d-flex flex-column flex-md-row justify-content-center align-items-center gap-2">
          ...
          <p className="m-0 fw-semibold text-center">30 Day Return Policy</p>
        </div>
      </Col>
      <Col xs={4} className="text-white">
        <div className="d-flex flex-column flex-md-row justify-content-center align-items-center gap-2">
          ...
          <p className="m-0 fw-semibold text-center">Fast Shipping</p>
        </div>
      </Col>
    </Row>
    // </Container>
